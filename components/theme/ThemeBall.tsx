...
export function ThemeBall({
  ...
  const numVal = typeof number === "number" ? number : parseInt(number, 10);

  // Determinar cor automática com base na faixa do número tradicional de bingo (B-I-N-G-O) se auto
